            ...
            <div class="table-container">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3">
                        ...
                        <button id="export_csv_leadgent" class="btn btn-primary" style="margin-right:20px">Export to CSV</button>

                            <form method="POST" action="<?php echo base_url('leads/upload_lead_leadgen'); ?>" enctype="multipart/form-data" class="mr-3 d-flex align-items-center">
                                ...
                                <?php endif; ?>
                                <select id="leadgent_statusfilter" class="form-control leadgent_statusfilter" style="width: 142px;">
                                ...
                                <button type="submit" class="btn btn-secondary" style="margin: 0 10px 0 10px">Upload</button>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#LeadsModal">Add Lead</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <div class="custom-header d-flex mb-2" style="align-items: center; justify-content: space-between; ">
                                <div class="ShowEntries">
                                    ...
                                    <input type="number" id="entries_8" value="10" min="1" step="1" style="width: 60px;">
                                </div>
                                <div class="SearchBox">
                            ...
                            <table class="table table-bordered table-hover nowrap display" id="leadgentdatatable" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Customer Name</th>
                        ...
                        <form id="detail_form">
                            <div class="form-row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="brandName" name="brandName" placeholder="Enter Previous Publisher">
                                </div>
                                <div class="form-group col-md-6">
                                    <div id="dynamicForm">
                                        <div id="inputFields3">
                                            ...
                                            <div class="mb-3 field-container d-flex gap-1">
                                                ...
                                                <button type="button" class="btn btn-danger removeFields_1"><i class="ti ti-trash"></i></button>
                                            </div>
                                        </div>
                                        <button type="button" id="addMoreTitle" class="btn btn-primary"><i class="ti ti-plus"></i></button>
                            ...
                            <div class="form-group col-md-6">
                                    <div id="dynamicForm">
                                        ...
                                        <div id="inputFields4">
                                            <div class="mb-3 field-container d-flex gap-1">
                                                ...
                                                <button type="button" class="btn btn-danger removeFields_2"><i class="ti ti-trash"></i></button>
                                            </div>
                                        </div>
                                        <button type="button" id="addMoreBookLink" class="btn btn-primary"><i class="ti ti-plus"></i></button>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="source" id="source">
                                        ...
                                        <?php if (!empty($this->session->userdata['userlogin']['full_name'])): ?>
                                            <option value="<?php echo htmlspecialchars($this->session->userdata['userlogin']['full_name']); ?>" selected>
                                                <?php echo htmlspecialchars($this->session->userdata['userlogin']['full_name']); ?>
                                            </option>
                                        <?php endif; ?>
                                    </select>
                                </div> -->
                        ...
                        <form id="edit_detail_form" class="edit_detail_form">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="sales_remarks" name="sales_remarks" placeholder="Sales Remarks">
                                </div>
                            </div>

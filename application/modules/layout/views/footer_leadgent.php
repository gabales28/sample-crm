...
<div class="modal fade  slide-right" id="activityModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="padding-right: 5rem !important;">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="userProfile_form" class="userProfile_form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control address" id="address" name="address" rows="3" placeholder="Address"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<script src="<?php echo base_url('assets/vendor/jquery/moment-with-locales.min.js'); ?>" type="text/javascript" ></script>

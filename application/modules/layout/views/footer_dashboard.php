...
<script src="<?php echo base_url('datepicker/js/bootstrap-daterangepicker.min.js'); ?>"></script>
<script src="<?php echo base_url('datepicker/js/daterangepicker.min.js'); ?>"></script>

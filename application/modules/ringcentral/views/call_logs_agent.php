        ...
        <div class="main-card-container">
            <div class="table-container">
                ...
                <div class="col-sm-4.5 d-inline-block mb-2">
                    <div id="reportpaymentrange_agent" style="background: #fff; cursor: pointer; padding: 10px 15px; border: 1px solid #ccc;">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover nowrap display" id="callLogsAgent_dataTable" width="100%"
                                cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>From</th>

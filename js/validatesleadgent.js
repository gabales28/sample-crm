$('#leadgent_taskmodaldatatable').DataTable({
    processing: true,
    serverSide: true,
    fixedColumns: {
        start: 2,
  ...
  //               $("#update_form .alert-danger").removeClass("alert-danger").addClass("alert-success");
    
  //               $("#update_form .alert-success").css("display", "block");
    
  //               $("#update_form .alert-success p").html(res.message);
  ...
  //               $("#update_form .alert-success").removeClass("alert-success").addClass("alert-danger");
    
  //               $("#update_form .alert-danger").css("display", "block");
    
  //               $("#update_form .alert-danger p").html(res.message);
    
  //               setTimeout(function(){
    
  //                       $("#update_form .alert-danger").css("display", "none");
